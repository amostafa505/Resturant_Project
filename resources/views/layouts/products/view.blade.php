          ...
          <div class="row">
            <div class="col-12 col-sm-6">
              ...
              <div class="col-12">
                ...
                <img src="{{Storage::disk('s3')->url($product->productImages[0]->name)}}" class="product-image" alt="Dish Image">
              </div>
              <div class="col-12 product-image-thumbs">
                @foreach ($product->productimages as $image)  
                  {{-- <div class="product-image-thumb active"><img src="{{Storage::url('/images/products/'.$image->name)}}" alt="Product Image"></div> --}}
                  <div class="product-image-thumb active"><img src="{{Storage::disk('s3')->url($image->name)}}" alt="Dish Image"></div>
                @endforeach
              </div>
            </div>
            @endif
