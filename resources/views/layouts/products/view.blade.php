          ...
          <div class="row">
            <div class="col-12 col-sm-6">
              ...
              <div class="col-12">
                ...
                <img src="{{'https://restaurant-project.s3.amazonaws.com/'.$product->productImages[0]->name}}" class="product-image" alt="Dish Image">
              </div>
              <div class="col-12 product-image-thumbs">
                @foreach ($product->productimages as $image)  
                  {{-- <div class="product-image-thumb active"><img src="{{Storage::url('/images/products/'.$image->name)}}" alt="Product Image"></div> --}}
                  <div class="product-image-thumb active"><img src="{{'https://restaurant-project.s3.amazonaws.com/'.$image->name}}" alt="Dish Image"></div>
                @endforeach
              </div>
            </div>
            @endif
            <div class="col-12 col-sm-6">
              ...
              <div class="bg-gray py-2 px-3 mt-4">
                ...
                <h4 class="mt-0">
                  ...
                  @if($product->discount)
                    <small>Discount: {{$product->discount}}% <br> </small>
                    <small>Price After Discount: {{$product->price_discount}} </small>
                  @endif
                </h4>
              </div>
